...
namespace ChatClient
{
    class ClientConnect
    {
        ...
        private string sendingM="";
        string receiveM="";

        public ClientConnect(string hostName, ushort hostPort)
        {
        ...
        public string getReceiveM()
        {
            return receiveM;
        }
        public void setReceiveM(string message)
        {
            receiveM = message;
        }
        public string getsendigM()
        {
            return sendingM;
        }
        ...
        private void handleDataReceive(IAsyncResult ar)
        {
            ...
            if (recvBytes > 0)
            {
                ...
                receiveM=Encoding.Unicode.GetString(msgByte);
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("자료 수신 대기 도중 오류 발생! 메세지: {0}", ex.Message);
                return;
            }
        }
        ...
        //출처: https://slaner.tistory.com/52 [꿈꾸는 프로그래머] 
